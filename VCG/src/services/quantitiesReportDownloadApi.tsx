...
export const getQuantitiesReportDownloadDetails = (payload: any): any => {
  const token = StorageService.getCookies("accessToken");
  try {
    return axios({
      method: "post",
      ...
      url: BASE_URL + `/${payload.reportType}/report/quantity/${payload.contentType}`, 
      data : payload,
      responseType:"blob"
