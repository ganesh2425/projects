...
const FAQs = () => {
  ...
  return (
    ...
    <div>
      {console.log(faqSuccess)}
      <Header />
      <div style={{ padding: "7px 10px", minHeight: "700px" }}>
        <div style={{ paddingBottom: "7px", fontSize: "1.75rem", padding: "0px" }}>FAQ</div>
        {faqSuccess && faqSuccess.map((accordion: any, index: any) => (
          <Accordion
          ...
          >
            ...
            >
              ...
              <p style={{fontSize:"16px"}} dangerouslySetInnerHTML={{ __html: accordion.question }} ></p>
             </Typography>
            </AccordionSummary>
            <AccordionDetails>
